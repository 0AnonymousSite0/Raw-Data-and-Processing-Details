...
TableNewsTexts = NewsData.sheet_by_name(u"****sheet of the news****")  # establish self-dic
...
TargetEntitiesData = xlrd.open_workbook("****file path of potentially affected stakeholder entities****")
TableEntitiesData = TargetEntitiesData.sheet_by_name(u'****sheet of potentially affected stakeholder entities****')
...
for NewsItem in TableNewsTexts.col_values(ColumnofText):
    ...
    # Identify entities
    for Token in ResultWithoutStopWordsAndSynonyms:
        # print(Token[0])
