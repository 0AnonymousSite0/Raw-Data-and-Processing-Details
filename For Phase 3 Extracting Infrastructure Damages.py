...
workbook = xlsxwriter.Workbook('C:\\Users\\zhou\\Desktop\\interdependence\\InfrastructureInterdependencyMatrix0802.xlsx') #change
...
TableNewsTexts = NewsData.sheet_by_name(u'revisedcon0004')  # establish self-dic
...
for line in open("C:\\Users\\zhou\\Desktop\\interdependence\\SynonymsInfrastructure.txt", "r", encoding='utf-8'):
...
for NewsItem in TableNewsTexts.col_values(ColumnofText):
    ...
    if  ResultWithoutStopWords==None:
        c = open("C:\\Users\\zhou\\Desktop\\interdependence\\word_vector_code_2.txt", 'a')
        c.write('\n')
    else:
        a=[]
        for i in ResultWithoutStopWords:
            ...
            c = open("C:\\Users\\zhou\\Desktop\\interdependence\\word_vector_code_2.txt", 'a',encoding ='utf-8-sig' )
   ...
   # c.close()
    ...
    if  array_index_of_word==None:
        f = open("C:\\Users\\zhou\\Desktop\\interdependence\\index_da.txt", 'a')
        f.write('\n')
    else:
        for i in range(len(array_index_of_word)):
            f = open("C:\\Users\\zhou\\Desktop\\interdependence\\index_da.txt", 'a',encoding='utf-8-sig')
